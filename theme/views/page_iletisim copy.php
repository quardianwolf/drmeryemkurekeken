...
<?php if((isset($article)) AND ($article == TRUE)): ?>
  ...
  <section class="contact-form" id="contact-form">
   <div class="container pt-8 mr-10">
      <div style="overflow:hidden;max-width:100%;width:1230px;height:500px;">
      <div id="my-map-canvas" style="height:100%; width:100%;max-width:100%;">
      <iframe style="height:100%;width:100%;border:0;" frameborder="0" src="https://www.google.com/maps/embed/v1/place?q=Ümraniye,+Elmalıkent,+Ümraniye/İstanbul,+Türkiye&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8">
      </iframe>
      </div>
      <a class="googlecoder" href="https://www.bootstrapskins.com/themes" id="grab-maps-authorization">
      </a>
      </div>
  </div>
  </div>
